...
#             subpart
#             for part in parts
#             for subpart in (part.split() if part not in delimiters
# else [part])
#         ]
...
# #         os.chmod(script_path, 0o755)  # 0o755 sets read, write,
# execute permissions for owner, and read, execute for others.
